...
Every criterion must have a versioned action mapping for:

- Missing evidence.
- Named-only evidence.
- Documented evidence that could be demonstrated.
- Demonstrated evidence needing packaging improvement.

The engine selects actions from the mapping. It must not invent courses, qualifications, technologies, experience, metrics, or candidate achievements.
